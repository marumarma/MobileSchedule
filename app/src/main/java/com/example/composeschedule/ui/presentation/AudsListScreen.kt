...
fun AudsListScreen(navController: NavController) {
    val viewModel : ClassroomsListViewModel = viewModel()
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                Box(modifier = Modifier
                    ...
                    Column(
                        ...
                        for (i in 0..viewModel.classrooms!!.size-1) {
                            for (j in 0..viewModel.classrooms!![i].classrooms.size-1){
                                val classNum = viewModel.classrooms!![i].classrooms[j].name
                                val corpNum = viewModel.classrooms!![i].address
                                Text(
